...
#include "MetroCarsWheelFront.h"
#include "MetroCarsWheelRear.h"
...
const FName AMetroCarsPawn::EngineAudioRPM("RPM");

#define LOCTEXT_NAMESPACE "VehiclePawn"

AMetroCarsPawn::AMetroCarsPawn()
{
	// Car mesh
	...
	// Wheels/Tyres
	// Setup the wheels
	Vehicle4W->WheelSetups[0].WheelClass = UMetroCarsWheelFront::StaticClass();
	Vehicle4W->WheelSetups[0].BoneName = FName("PhysWheel_FL");
	Vehicle4W->WheelSetups[0].AdditionalOffset = FVector(0.f, -8.f, 0.f);

	Vehicle4W->WheelSetups[1].WheelClass = UMetroCarsWheelFront::StaticClass();
	Vehicle4W->WheelSetups[1].BoneName = FName("PhysWheel_FR");
	Vehicle4W->WheelSetups[1].AdditionalOffset = FVector(0.f, 8.f, 0.f);

	Vehicle4W->WheelSetups[2].WheelClass = UMetroCarsWheelRear::StaticClass();
	Vehicle4W->WheelSetups[2].BoneName = FName("PhysWheel_BL");
	Vehicle4W->WheelSetups[2].AdditionalOffset = FVector(0.f, -8.f, 0.f);

	Vehicle4W->WheelSetups[3].WheelClass = UMetroCarsWheelRear::StaticClass();
    ...
    SpringArmRear->SetupAttachment(RootComponent);
    SpringArmRear->TargetArmLength = 125.0f;
    SpringArmRear->bEnableCameraLag = false;
    SpringArmRear->bEnableCameraRotationLag = false;
    SpringArmRear->bInheritPitch = true;
    SpringArmRear->bInheritYaw = true;
    SpringArmRear->bInheritRoll = true;
...
void AMetroCarsPawn::SetupPlayerInputComponent(class UInputComponent* InputComponent)
{
	...
	InputComponent->BindAxis("MoveForward", this, &AMetroCarsPawn::MoveForward);
	InputComponent->BindAxis("MoveRight", this, &AMetroCarsPawn::MoveRight);
	InputComponent->BindAxis(LookUpBinding);
	InputComponent->BindAxis(LookRightBinding);

	InputComponent->BindAction("Handbrake", IE_Pressed, this, &AMetroCarsPawn::OnHandbrakePressed);
	InputComponent->BindAction("Handbrake", IE_Released, this, &AMetroCarsPawn::OnHandbrakeReleased);
	InputComponent->BindAction("SwitchCamera", IE_Pressed, this, &AMetroCarsPawn::OnToggleCamera);

	InputComponent->BindAction("ResetVR", IE_Pressed, this, &AMetroCarsPawn::OnResetVR); 
}

void AMetroCarsPawn::MoveForward(float Val)
{
	GetVehicleMovementComponent()->SetThrottleInput(Val);

}

void AMetroCarsPawn::MoveRight(float Val)
{
	GetVehicleMovementComponent()->SetSteeringInput(Val);
}

void AMetroCarsPawn::OnHandbrakePressed()
{
	GetVehicleMovementComponent()->SetHandbrakeInput(true);
}

void AMetroCarsPawn::OnHandbrakeReleased()
{
	GetVehicleMovementComponent()->SetHandbrakeInput(false);
}

void AMetroCarsPawn::OnToggleCamera()
{
	EnableIncarView(!bInCarCameraActive);
}

void AMetroCarsPawn::EnableIncarView(const bool bState)
{
...
void AMetroCarsPawn::Tick(float Delta)
{
	Super::Tick(Delta);
...
void AMetroCarsPawn::UpdateHUDStrings()
{
...
void AMetroCarsPawn::SetupInCarHUD()
{
...
void AMetroCarsPawn::UpdatePhysicsMaterial()
{
